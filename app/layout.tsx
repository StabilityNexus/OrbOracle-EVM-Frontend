...
export const metadata: Metadata = {
  ...
  description:
    "OrbOracle is a decentralized oracle network providing reliable price feeds and data for DeFi applications. Create custom oracles, manage voting weights, and access real-time blockchain data across multiple networks.",
  keywords: [
    "OrbOracle",
  ...
  openGraph: {
    ...
    description:
      "OrbOracle is a decentralized oracle network providing reliable price feeds and data for DeFi applications. Create custom oracles and access real-time blockchain data.",
  ...
  twitter: {
    ...
    title: "OrbOracle | Decentralized Oracle Network",
    description:
      "OrbOracle is a decentralized oracle network providing reliable price feeds and data for DeFi applications.",
